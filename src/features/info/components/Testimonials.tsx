        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative h-full bg-card rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1 border border-border/50 hover:border-brand-gold/30 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-6">
                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-brand-gold/10 group-hover:bg-brand-gold/20 transition-colors duration-300">
                  ...
                  <div className="flex items-center gap-4">
                    {/* Decorative divider */}
                    <div className="w-12 h-px bg-linear-to-r from-brand-gold via-brand-saffron to-brand-maroon" />
        ...
        >
          <div className="inline-flex flex-col items-center gap-3">
            <div className="flex items-center gap-2">
              <div className="w-8 h-px bg-linear-to-r from-transparent to-brand-gold/50" />
              <div className="w-2 h-2 rounded-full bg-brand-gold" />
              <div className="w-8 h-px bg-linear-to-l from-transparent to-brand-gold/50" />
            </div>
            <p className="text-brand-maroon/80 font-serif italic text-lg">
              &quot;Gan Gan Ganaat Bote&quot;
            </p>
          </div>
        </motion.div>

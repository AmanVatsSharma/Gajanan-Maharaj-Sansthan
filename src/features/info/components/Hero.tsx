  ...
  return (
    <div className="relative flex min-h-[85vh] svh:min-h-[85svh] items-center justify-center overflow-hidden bg-brand-maroon/10">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="h-full w-full bg-[url('/gallery/0c23d827-555f-47ee-9cc8-f05072f21e48.jpeg')] bg-cover bg-center scale-105 animate-in fade-in duration-[2000ms]" />
      </div>
      ...
      <div className="container relative z-20 text-center text-white pt-20">
        ...
        <h1 className="mb-8 text-4xl md:text-7xl lg:text-8xl font-bold font-heading shadow-sm text-transparent bg-clip-text bg-gradient-to-b from-white to-white/90 drop-shadow-lg animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200 text-balance motion-reduce:animate-none">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
          <Link href="/booking">
            <Button size="lg" variant="premium" className="min-w-[220px] text-lg h-14 rounded-full">
              Book Accommodation
            </Button>
          </Link>
          <Link href="/locations">
            <Button size="lg" variant="outline" className="bg-white/10 hover:bg-white/20 text-white border-white/30 backdrop-blur-sm min-w-[220px] text-lg h-14 rounded-full hover:-translate-y-1 transition-all duration-300">
              View Locations
            </Button>
          </Link>
        </div>

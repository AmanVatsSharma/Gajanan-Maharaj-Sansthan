...
export function PlanYourVisit() {
  return (
    <section className="relative py-20 md:py-28 bg-linear-to-b from-background via-brand-maroon/5 to-background overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-brand-saffron/10 flex items-center justify-center">
                <Clock className="h-6 w-6 text-brand-saffron" />
              </div>
              <h3 className="text-2xl font-bold font-heading text-brand-maroon">
                Darshan Timings
              </h3>
            </div>
            <div className="space-y-4">
              {darshanTimings.map((timing) => (
                <div
                  key={timing.type}
                  className="flex justify-between items-start p-4 rounded-xl bg-muted/50 hover:bg-muted transition-colors"
                >
                  <div>
                  ...
                  <span className="text-brand-maroon font-semibold text-sm whitespace-nowrap ml-4">
                    {timing.time}
                  </span>
                </div>
              ))}
        ...
        >
          <div className="bg-card rounded-2xl p-8 shadow-lg border border-border/50">
            <h3 className="text-2xl font-bold font-heading text-brand-maroon mb-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {transportOptions.map((option) => {
                ...
                return (
                  ...
                  >
                    <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-brand-saffron/10 flex items-center justify-center">
                      <IconComponent className="h-7 w-7 text-brand-saffron" />
                    </div>
        ...
        >
          <div className="bg-brand-saffron/5 border border-brand-saffron/20 rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-lg bg-brand-saffron/20 flex items-center justify-center">
                <Info className="h-5 w-5 text-brand-saffron" />
              </div>
              <h3 className="text-xl font-bold font-heading text-brand-maroon">
                Important Notes
              </h3>
            </div>
